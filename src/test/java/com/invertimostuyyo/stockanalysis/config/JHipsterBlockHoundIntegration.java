...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.invertimostuyyo.stockanalysis.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.invertimostuyyo.stockanalysis.security.DomainUserDetailsService", "createSpringSecurityUser");
