...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './analysis.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANALYSIS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANALYSIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANALYSIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANALYSIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANALYSIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANALYSIS actions', async () => {
      const expectedActions = [
        {
