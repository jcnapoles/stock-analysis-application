...
export const StockDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="stockAnalysisApplicationApp.stock.delete.question">
        <Translate contentKey="stockAnalysisApplicationApp.stock.delete.question" interpolate={{ id: stockEntity.id }}>
