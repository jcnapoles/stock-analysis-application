...
export const PositionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="stockAnalysisApplicationApp.position.delete.question">
        <Translate contentKey="stockAnalysisApplicationApp.position.delete.question" interpolate={{ id: positionEntity.id }}>
