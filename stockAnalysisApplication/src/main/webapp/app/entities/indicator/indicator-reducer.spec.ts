...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './indicator.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INDICATOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_INDICATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INDICATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INDICATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INDICATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INDICATOR actions', async () => {
      const expectedActions = [
        {
