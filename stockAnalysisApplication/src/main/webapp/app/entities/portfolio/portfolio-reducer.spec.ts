...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './portfolio.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PORTFOLIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PORTFOLIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PORTFOLIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PORTFOLIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PORTFOLIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PORTFOLIO actions', async () => {
      const expectedActions = [
        {
